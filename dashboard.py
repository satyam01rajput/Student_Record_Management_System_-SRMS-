...
class RMS:
    def __init__(self,root):
       ...
       title=Label(self.root,text= "Student Result Management System",padx=20,compound=LEFT,image=self.logo_dash,font=("goudy old style" , 20 , "bold"),bg="#033054",fg="white").place(x=0,y=0,relwidth=1,height=40)
    ...
    #    Content Window
       ...
       self.lbl_bg=Label(self.root,image=self.bg_img).place(x=300,y=200,width=620,height=250)

       

       self.lbl_course = Label(self.root,text="Total Courses\n[0]",font=("goudy old style",20),bd=10,relief=RIDGE,bg="#e43b06",fg="white")
       self.lbl_course.place(x=100,y=530,width=300,height=100)

       self.lbl_student = Label(self.root,text="Total Students\n[0]",font=("goudy old style",20),bd=10,relief=RIDGE,bg="#a506e4",fg="white")
       self.lbl_student.place(x=410,y=530,width=300,height=100)

       self.lbl_result = Label(self.root,text="Total Result\n[0]",font=("goudy old style",20),bd=10,relief=RIDGE,bg="#410528",fg="white")
       self.lbl_result.place(x=720,y=530,width=300,height=100)

       footer=Label(self.root,text = "Student Result Management System\nContact Us : 8269922231",font=("goudy old style" , 20 , "bold"),bg="#033054",fg="white").pack(side=BOTTOM,fill=X)
       self.update_details()
